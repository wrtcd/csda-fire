// GEE: Hughes Fire (CA) — Landsat 8/9 + Sentinel-2 (RGB-only)
// Goal:
// - Manually inspect all POST candidates by toggling layers
// - List (date, cloud%, id) in Console
// - Add targeted exports after you pick

var PLACE_LABEL = 'Hughes Fire (CA)';
var ALARM_DATE = '2025-01-22';
var PRE_LOOKBACK_DAYS = 45;
var POST_LOOKAHEAD_DAYS = 90;
var POST_END_OVERRIDE = ''; // set e.g. '2025-03-01' (end is exclusive in filterDate); '' disables override

var PERIMETERS_ASSET = 'projects/earthengine-441016/assets/California_Fire_Perimeters';
var PERIM_FIRE_NAME = 'Hughes';
var PERIM_YEAR = 2025;
var PERIM_BUFFER_M = 15000;

// If perimeter asset is slow/unavailable, use fixed bbox AOI instead.
// This bbox was derived from `powerpoint/shapefile/calfire.geojson` feature FIRE_NAME=HUGHES, YEAR_=2025.
// Format: [minLon, minLat, maxLon, maxLat] in EPSG:4326
var USE_FIXED_BBOX_INSTEAD_OF_PERIMETER = true;
var FIXED_BBOX_4326 = [-118.62692600097606, 34.475389469965435, -118.54021497731603, 34.58141236921067];
...
lsPostCol = lsPostCol.sort('cloudPct').sort('system:time_start');
...
// =========================
var LS_EXPORT_DATE = '2025-02-23'; // Landsat you picked
var S2_EXPORT_DATE = '2025-02-01'; // Sentinel-2 you picked
...
// Run exports:
exportFirstIfExists(lsExportCol, lsRgb, LS_VIZ, 'hughes_landsat_' + LS_EXPORT_DATE, 30);
exportAll(s2ExportCol, s2Rgb, S2_VIZ, 'hughes_s2_' + S2_EXPORT_DATE, 10, 3);
