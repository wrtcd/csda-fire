// GEE: Mountain Fire (CA) — Landsat 8/9 + Sentinel-2 (RGB-only)
// Goal:
// - Manually inspect all POST candidates by toggling layers
// - List (date, cloud%, id) in Console
// - No exports locked in until you pick

var PLACE_LABEL = 'Mountain Fire (CA)';
var ALARM_DATE = '2024-11-06';
var PRE_LOOKBACK_DAYS = 45;
var POST_LOOKAHEAD_DAYS = 90;
var POST_END_OVERRIDE = ''; // set e.g. '2024-12-15' (end is exclusive in filterDate); '' disables override

var PERIMETERS_ASSET = 'projects/earthengine-441016/assets/California_Fire_Perimeters';
var PERIM_FIRE_NAME = 'Mountain';
var PERIM_YEAR = 2024;
var PERIM_BUFFER_M = 12000;

// If perimeter asset is slow/unavailable, use fixed bbox AOI instead.
// This bbox was derived from `powerpoint/shapefile/calfire.geojson` feature FIRE_NAME=MOUNTAIN, YEAR_=2024.
// Format: [minLon, minLat, maxLon, maxLat] in EPSG:4326
var USE_FIXED_BBOX_INSTEAD_OF_PERIMETER = true;
var FIXED_BBOX_4326 = [-119.12268700030084, 34.22281900033936, -118.93435300011276, 34.3584541330971];
...
if (MAP_ALL_POST_IMAGES) {
  addAllAsLayers(lsPostCol, LS_VIZ, lsRgb, 'Landsat POST', 'CLOUD_COVER', 'LANDSAT_PRODUCT_ID', MAX_MAP_LAYERS);
...
// =========================
var LS_EXPORT_DATE = '2024-11-10'; // 1 Landsat scene you picked
var S2_EXPORT_DATE = '2024-11-08'; // 3 Sentinel-2 granules you picked
...
// Run exports:
exportFirstIfExists(lsExportCol, lsRgb, LS_VIZ, 'mountain_landsat_' + LS_EXPORT_DATE, 30);
exportAll(s2ExportCol, s2Rgb, S2_VIZ, 'mountain_s2_' + S2_EXPORT_DATE, 10, 3);
